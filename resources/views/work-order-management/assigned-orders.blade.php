            ...
            <form class="row g-3 align-items-end" id="filter-form">
                <div class="col-md-4">
                    ...
                    <div class="input-group" id="start_date">
                        <input type="text" class="form-control" id="start_date_input" name="start_date"
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group" id="end_date">
                        <input type="text" class="form-control" id="end_date_input" name="end_date"
                            placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container='#end_date'
                            data-provide="datepicker" data-date-autoclose="true"
