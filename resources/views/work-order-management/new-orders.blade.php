				...
				<div class="col-md-4">
					...
					<div class="input-group" id="start_date">
						<input type="text" class="form-control" id="start_date" name="start_date" placeholder="yyyy-mm-dd"
							data-date-format="yyyy-mm-dd" data-date-container='#start_date' data-provide="datepicker"
							data-date-autoclose="true" value="{{ old('start_date') ?: date('Y-m-01') }}">
				...
				<div class="col-md-4">
					...
					<div class="input-group" id="end_date">
						<input type="text" class="form-control" id="end_date" name="end_date" placeholder="yyyy-mm-dd"
							data-date-format="yyyy-mm-dd" data-date-container='#end_date' data-provide="datepicker" data-date-autoclose="true"
			...
			<form id="assign-form" action="{{ route('work-order-management.updateOrInsertOrder') }}" method="POST"
				...
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<select name="assign_labels[]" id="assign_labels" class="form-control select2" multiple="multiple"
					...
					<div class="mb-3">
						...
						<div class="input-group" id="assign_date_picker">
							<input type="text" name="assign_date" id="assign_date" class="form-control" placeholder="yyyy-mm-dd"
								data-date-format="yyyy-mm-dd" data-date-container='#assign_date_picker' data-provide="datepicker"
			...
			function loadBarChart() {
				...
				$.ajax({
					...
					error: function() {
						...
						hideChartLoading('bar');
						$(`#barChart`).siblings('.chart-loading').html(
				...
				$.ajax({
					...
					success: function(res) {
						let pieData = res.labels.map((label, i) => ({
							...
							itemStyle: {
								color: res.datasets[0].backgroundColor[i]
							}
						}));
					...
					error: function() {
						...
						hideChartLoading('pie');
						$(`#pieChart`).siblings('.chart-loading').html(
							'<p class="text-danger">Failed to load chart data</p>');
					}
				});
			}
