                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group" id="start_date">
                        <input type="text" class="form-control" id="start_date" name="start_date"
                            placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container='#start_date'
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group" id="end_date">
                        <input type="text" class="form-control" id="end_date" name="end_date" placeholder="yyyy-mm-dd"
                            data-date-format="yyyy-mm-dd" data-date-container='#end_date' data-provide="datepicker"
                            data-date-autoclose="true" value="{{ old('end_date') ?: date('Y-m-d') }}">
                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                    </div>
                </div>
                <div class="col-md-4">
