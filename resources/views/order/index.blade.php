...
@section('content')
	<form method="POST" action="{{ route('order.index.update', $id) }}" enctype="multipart/form-data" id="mainOrderForm">
		...
		<div class="modal fade bs-modal-history-log-order" tabindex="-1" role="dialog" aria-labelledby="logOrderModalLabel"
			aria-hidden="true">
					...
					<div class="card-body">
						<div class="card-title d-flex justify-content-between align-items-center">
							...
							<div class="d-flex align-items-center">
								...
								<button type="button" class="btn btn-sm btn-light btn-toggle-card" data-bs-toggle="collapse"
									data-bs-target="#card-update-form" aria-expanded="true">
									<i class="fa fa-minus"></i>
								</button>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mb-3">
										...
										<input type="text" name="report_phone_number" id="report_phone_number" class="form-control"
											oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="+62" required />
									</div>
								</div>
								<div class="col-md-6">
									<div class="mb-3">
										...
										<div class="input-group">
											<input type="text" name="report_coordinates_location" id="report_coordinates_location"
												class="form-control" />
								...
								<div class="col-md-6">
									<div class="mb-3">
										<label for="report_odp_name" class="form-label">Optical Distribution Point (ODP)
											Name</label>
										<input type="text" name="report_odp_name" id="report_odp_name" class="form-control"
											placeholder="ODP-xxx-xxx/xxx" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="mb-3">
										...
										<div class="input-group">
											...
											<button type="button" class="btn btn-outline-secondary" id="btnMarkOdpLocation"
												title="Mark Current Location for ODP">
												<i class="fa fa-map-marker"></i>
											</button>
										</div>
									</div>
								...
								<div class="col-md-6">
									<div class="mb-3">
										...
										<input type="text" name="report_valins_id" id="report_valins_id" class="form-control"
								...
								<div class="col-md-6">
									<div class="mb-3">
										<label for="report_refferal_order_code" class="form-label">Order Code
											(Referral)</label>
										<input type="text" name="report_refferal_order_code" id="report_refferal_order_code"
											class="form-control" placeholder="Wonum atau Incident" />
									</div>
								</div>
								<div class="col-md-12">
									<div class="mb-3">
