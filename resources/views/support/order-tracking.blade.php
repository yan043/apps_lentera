	...
	<div class="card mb-4">
		<div class="card-body">
			...
			<div class="input-group mb-3">
				<input type="text" class="form-control" id="searchOrderInput" placeholder="Search Order Number or Payment Number"
					aria-label="Search" minlength="10">
			</div>
		</div>
	</div>
	<div class="card">
		<div class="card-body">
			<div class="table-responsive">
				<table class="table table-striped table-hover text-center detail-data-table" id="orderTrackingTable">
					<thead>
						<tr>
							<th>No</th>
							<th>Order Code</th>
