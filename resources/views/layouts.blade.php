            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="clock-container d-flex align-items-center"
                        style="margin-left: 10px; font-size: 14px; color: #73879c;">
                        <span id="clock"></span>
                    </div>
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="/assets/images/{{ Session::get('gender') }}.png" alt="Header Avatar">
                        ...
                        @if (Session::get('role_name') != 'Technician')
                            <li class="{{ Request::is('work-order-management/*') ? 'active' : '' }}">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li class="{{ Request::is('work-order-management/new') ? 'active' : '' }}"><a
                            ...
                            <li class="{{ Request::is('technician-attendance/*') ? 'active' : '' }}">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li
                                        class="{{ Request::is('technician-attendance/daily-attendance') ? 'active' : '' }}">
                                        <a href="/technician-attendance/daily-attendance">Daily Attendance</a>
                                    </li>
                                    <li
                                        class="{{ Request::is('technician-attendance/shift-management') ? 'active' : '' }}">
                                        <a href="/technician-attendance/shift-management">Shift Management</a>
                                    </li>
                                    <li
                                        class="{{ Request::is('technician-attendance/leave-request') ? 'active' : '' }}">
                                        <a href="/technician-attendance/leave-request">Leave Requests</a>
                                    </li>
                                    <li
                                        class="{{ Request::is('technician-attendance/attendance-report') ? 'active' : '' }}">
                                        <a href="/technician-attendance/attendance-report">Attendance Report</a>
                                    </li>
                                    <li
                                        class="{{ Request::is('technician-attendance/late-absence-logs') ? 'active' : '' }}">
                                        <a href="/technician-attendance/late-absence-logs">Late & Absence Logs</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('inventory-management/*') ? 'active' : '' }}">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li
                                        class="{{ Request::is('inventory-management/stock-overview') ? 'active' : '' }}">
                                        <a href="/inventory-management/stock-overview">Stock Overview</a>
                                    </li>
                                    <li
                                        class="{{ Request::is('inventory-management/material-request') ? 'active' : '' }}">
                                        <a href="/inventory-management/material-request">Material Request</a>
                                    </li>
                                    <li
                                        class="{{ Request::is('inventory-management/material-inbound') ? 'active' : '' }}">
                                        <a href="/inventory-management/material-inbound">Material Inbound</a>
                                    </li>
                                    <li
                                        class="{{ Request::is('inventory-management/material-usage') ? 'active' : '' }}">
                                        <a href="/inventory-management/material-usage">Material Usage</a>
                                    </li>
                                    <li
                                        class="{{ Request::is('inventory-management/material-return') ? 'active' : '' }}">
                                        <a href="/inventory-management/material-return">Material Return</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('reports-payment/*') ? 'active' : '' }}">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li class="{{ Request::is('reports-payment/daily-reports') ? 'active' : '' }}"><a
                                            href="/reports-payment/daily-reports">Daily Reports</a></li>
                                    <li
                                        class="{{ Request::is('reports-payment/technician-performance') ? 'active' : '' }}">
                                        <a href="/reports-payment/technician-performance">Technician Performance</a>
                                    </li>
                                    <li class="{{ Request::is('reports-payment/billing-payment') ? 'active' : '' }}">
                                        <a href="/reports-payment/billing-payment">Billing & Payment</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="{{ Request::is('employee-management/*') ? 'active' : '' }}">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li class="{{ Request::is('employee-management/list') ? 'active' : '' }}"><a
                                            href="/employee-management/list">Employee List</a></li>
                                    <li
                                        class="{{ Request::is('employee-management/roles-permissions') ? 'active' : '' }}">
                                        <a href="/employee-management/roles-permissions">Employee Roles &
                                            Permissions</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('organization-structure/*') ? 'active' : '' }}">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li class="{{ Request::is('organization-structure/regional') ? 'active' : '' }}">
                                        <a href="/organization-structure/regional">Regional</a>
                                    </li>
                                    <li class="{{ Request::is('organization-structure/witel') ? 'active' : '' }}"><a
                                            href="/organization-structure/witel">Witel</a></li>
                                    <li class="{{ Request::is('organization-structure/sub-unit') ? 'active' : '' }}">
                                    ...
                                    <li class="{{ Request::is('organization-structure/team') ? 'active' : '' }}"><a
                                            href="/organization-structure/team">Team</a></li>
                            ...
                            <li class="{{ Request::is('reporting-configuration/*') ? 'active' : '' }}">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li class="{{ Request::is('reporting-configuration/actions') ? 'active' : '' }}">
                                        <a href="/reporting-configuration/actions">Order Actions</a>
                                    </li>
                                    <li class="{{ Request::is('reporting-configuration/labels') ? 'active' : '' }}"><a
                                            href="/reporting-configuration/labels">Order Labels</a></li>
                                </ul>
                            </li>
                        @endif
                    </ul>
                                        ...
                                        @for ($i = 1; $i <= count(Request::segments()); $i++)
                                            <li class="breadcrumb-item {{ $i == count(Request::segments()) ? 'active' : '' }}"
                                                ...
                                                @if ($i < count(Request::segments()))
                                                    <a
                                                        href="{{ url(implode('/', array_slice(Request::segments(), 0, $i))) }}">
