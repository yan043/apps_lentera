					...
					<ul class="metismenu list-unstyled" id="side-menu">
						...
						@if (Session::get('role_name') != 'Technician')
							...
							<li class="{{ Request::is('technician-attendance/*') ? 'active' : '' }}">
								...
								<ul class="sub-menu" aria-expanded="false">
									<li class="{{ Request::is('technician-attendance/daily-attendance') ? 'active' : '' }}">
										<a href="/technician-attendance/daily-attendance">Daily Attendance</a>
									</li>
									<li class="{{ Request::is('technician-attendance/shift-management') ? 'active' : '' }}">
										<a href="/technician-attendance/shift-management">Shift Management</a>
									</li>
									<li class="{{ Request::is('technician-attendance/leave-request') ? 'active' : '' }}">
										<a href="/technician-attendance/leave-request">Leave Requests</a>
									</li>
									<li class="{{ Request::is('technician-attendance/attendance-report') ? 'active' : '' }}">
										<a href="/technician-attendance/attendance-report">Attendance Report</a>
									</li>
									<li class="{{ Request::is('technician-attendance/late-absence-logs') ? 'active' : '' }}">
							...
							<li class="{{ Request::is('inventory-management/*') ? 'active' : '' }}">
								...
								<ul class="sub-menu" aria-expanded="false">
									<li class="{{ Request::is('inventory-management/stock-overview') ? 'active' : '' }}">
										<a href="/inventory-management/stock-overview">Stock Overview</a>
									</li>
									<li class="{{ Request::is('inventory-management/material-request') ? 'active' : '' }}">
										<a href="/inventory-management/material-request">Material Request</a>
									</li>
									<li class="{{ Request::is('inventory-management/material-inbound') ? 'active' : '' }}">
										<a href="/inventory-management/material-inbound">Material Inbound</a>
									</li>
									<li class="{{ Request::is('inventory-management/material-usage') ? 'active' : '' }}">
										<a href="/inventory-management/material-usage">Material Usage</a>
									</li>
									<li class="{{ Request::is('inventory-management/material-return') ? 'active' : '' }}">
							...
							<li class="{{ Request::is('reports-payment/*') ? 'active' : '' }}">
								...
								<ul class="sub-menu" aria-expanded="false">
									...
									<li class="{{ Request::is('reports-payment/technician-performance') ? 'active' : '' }}">
							...
							<li class="{{ Request::is('employee-management/*') ? 'active' : '' }}">
								...
								<ul class="sub-menu" aria-expanded="false">
									...
									<li class="{{ Request::is('employee-management/roles-permissions') ? 'active' : '' }}">
