            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('profile.store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="date_of_birth" id="date_of_birth" class="form-control datepicker" placeholder="Masukan Tanggal Lahir" value="{{ $data->date_of_birth }}" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="password" id="password" class="form-control" placeholder="Masukan Password Baru (Opsional)" />
                    </div>
