						...
						<div class="card-body pt-0">
							<div class="auth-logo">
								<a href="#" class="auth-logo-light">
									<div class="avatar-md profile-user-wid mb-4">
										<span class="avatar-title rounded-circle bg-light">
											<img src="/assets/images/lentera-dark.png" alt="" class="rounded-circle" height="80">
										</span>
									</div>
								</a>
								<a href="#" class="auth-logo-dark">
									<div class="avatar-md profile-user-wid mb-4">
										<span class="avatar-title rounded-circle bg-light">
											<img src="/assets/images/lentera-light.png" alt="" class="rounded-circle" height="80">
										</span>
									</div>
								</a>
							</div>
								...
								<form method="POST">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="nik" name="nik" placeholder="Enter NIK"
											minlength="6" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required>
									</div>
									...
									<div class="mb-3 text-center">
										<div class="d-flex justify-content-center">
											<img id="captcha-img" src="{{ captcha_src() }}" alt="captcha" class="img-fluid"
