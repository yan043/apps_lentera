		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="/reporting-configuration/labels/store" method="POST">
						@csrf
						<div class="mb-3">
							<label class="form-label">Label Name</label>
							<input type="text" class="form-control" name="name" placeholder="Masukkan Nama Label" required>
						</div>
				...
				columns: [{
					...
					},
					{
						...
						render: function(data, type, row) {
							return `
                            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modal-edit" onclick="openEditModal(${data}, '${row.name}')">
		...
		function confirmDelete(id) {
			Swal.fire({
				...
				if (result.isConfirmed) {
					window.location.href = '/reporting-configuration/labels/destroy/' + id;
				}
			});
		}
	</script>
