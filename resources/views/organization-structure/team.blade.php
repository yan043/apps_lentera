            ...
            <table class="table table-striped text-center detail-data-table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Technician 1</th>
                        <th class="text-center">Technician 2</th>
                        <th class="text-center"></th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="modal-body">
                <form action="{{ route('organization-structure.team.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control select2" id="technician2_id_add" name="technician2" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit-form" action="{{ route('organization-structure.team.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Team Name</label>
                        <input type="text" class="form-control" id="name_edit" name="name" placeholder="Enter Team Name" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Technician 1</label>
    ...
    $(document).ready(function() {
        ...
        $('#modal-add, #modal-edit').on('shown.bs.modal', function() {
            $(this).find('.select2').select2({
                ...
                placeholder: function() {
                    return $(this).attr('id').includes('service_area') ? "Pilih Service Area" :
                           $(this).attr('id').includes('technician1') ? "Pilih Technician 1" :
                           $(this).attr('id').includes('technician2') ? "Pilih Technician 2" : "Pilih opsi";
                }
            });
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                saSelect.empty().append('<option value="" selected disabled>Pilih Service Area</option>');
