				...
				<div class="modal-body">
					<form action="/organization-structure/sub-unit/store" method="POST">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" name="name" placeholder="Enter Sub-Unit Name" required>
						</div>
...
@section('scripts')
	...
	<script>
				...
				columns: [{
					...
					},
					{
						...
						render: function(data, type, row) {
							return `
                            <button type="button" class="btn btn-sm btn-primary" onclick="openEditModal(${data}, '${row.regional_id}', '${row.name}')">
		...
		function openEditModal(id, regionalId, name) {
