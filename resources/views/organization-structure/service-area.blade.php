            ...
            <table class="table table-striped text-center detail-data-table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Head Service Area</th>
                        <th class="text-center">Officer Service Area</th>
                        <th class="text-center">Kordinator Lapangan 1</th>
                        <th class="text-center">Kordinator Lapangan 2</th>
                        <th class="text-center"></th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="modal-body">
                <form action="{{ route('organization-structure.service-area.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control select2" id="koordinator_lapangan_2_id_add" name="kordinator_lapangan2" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit-form" action="{{ route('organization-structure.service-area.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Service Area Name</label>
                        <input type="text" class="form-control" id="name_edit" name="name" placeholder="Enter Service Area Name" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Chat ID</label>
                        <input type="text" class="form-control" id="chat_id_edit" name="chat_id" placeholder="Enter Chat ID" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Head of Service Area</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label">Koordinator Lapangan 2</label>
                        <select class="form-control select2" id="koordinator_lapangan_2_id_edit" name="kordinator_lapangan2" required>
                            <option value="" selected disabled>Pilih Koordinator Lapangan 2</option>
                        </select>
                    </div>
                    <div class="d-flex justify-content-end">
    ...
    $(document).ready(function() {
            ...
            $(this).find('.select2').select2({
                ...
                placeholder: function() {
                    return $(this).attr('id').includes('regional') ? "Pilih Regional" :
                           ...
                           $(this).attr('id').includes('head_service_area') ? "Pilih Head of Service Area" :
                           $(this).attr('id').includes('officer_service_area') ? "Pilih Officer of Service Area" :
                           $(this).attr('id').includes('koordinator_lapangan_1') ? "Pilih Koordinator Lapangan 1" :
                           $(this).attr('id').includes('koordinator_lapangan_2') ? "Pilih Koordinator Lapangan 2" : "Pilih opsi";
                }
            });
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                headSelect.empty().append('<option value="" selected disabled>Pilih Head of Service Area</option>');
                data.forEach(function(item) {
                    headSelect.append(`<option value="${item.nik}">${item.full_name}</option>`);
                });
            }
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                officerSelect.empty().append('<option value="" selected disabled>Pilih Officer of Service Area</option>');
                data.forEach(function(item) {
                    officerSelect.append(`<option value="${item.nik}">${item.full_name}</option>`);
                });
            }
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                koor1Select.empty().append('<option value="" selected disabled>Pilih Koordinator Lapangan 1</option>');
                data.forEach(function(item) {
                    koor1Select.append(`<option value="${item.nik}">${item.full_name}</option>`);
                });
            }
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                koor2Select.empty().append('<option value="" selected disabled>Pilih Koordinator Lapangan 2</option>');
                data.forEach(function(item) {
                    koor2Select.append(`<option value="${item.nik}">${item.full_name}</option>`);
                });
            }
        });
        ...
        let table = $(".detail-data-table").DataTable({
            ...
            columns: [
                ...
                { data: 'name' },
                { data: 'chat_id' },
                { data: 'head_service_area_name' },
                { data: 'officer_service_area_name' },
                { data: 'kordinator_lapangan1_name' },
                { data: 'kordinator_lapangan2_name' },
                {
                    data: 'id',
