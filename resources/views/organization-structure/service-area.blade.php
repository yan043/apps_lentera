                ...
                <div class="modal-body">
                    <form action="{{ route('organization-structure.service-area.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Enter Service Area Name"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control select2" id="head_service_area_id_add" name="head_service_area"
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control select2" id="officer_service_area_id_add"
                                name="officer_service_area" required>
                                <option value="" selected disabled>Pilih Officer of Service Area</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Koordinator Lapangan 1</label>
                            <select class="form-control select2" id="koordinator_lapangan_1_id_add"
                                name="kordinator_lapangan1" required>
                                <option value="" selected disabled>Pilih Koordinator Lapangan 1</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Koordinator Lapangan 2</label>
                            <select class="form-control select2" id="koordinator_lapangan_2_id_add"
                                name="kordinator_lapangan2" required>
    ...
    <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-form" action="{{ route('organization-structure.service-area.store') }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            <label class="form-label">Chat ID</label>
                            <input type="text" class="form-control" id="chat_id_edit" name="chat_id"
                                placeholder="Enter Chat ID" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Head of Service Area</label>
                            <select class="form-control select2" id="head_service_area_id_edit" name="head_service_area"
                                required>
                                <option value="" selected disabled>Pilih Head of Service Area</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Officer of Service Area</label>
                            <select class="form-control select2" id="officer_service_area_id_edit"
                                name="officer_service_area" required>
                                <option value="" selected disabled>Pilih Officer of Service Area</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Koordinator Lapangan 1</label>
                            <select class="form-control select2" id="koordinator_lapangan_1_id_edit"
                                name="kordinator_lapangan1" required>
                                <option value="" selected disabled>Pilih Koordinator Lapangan 1</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Koordinator Lapangan 2</label>
                            <select class="form-control select2" id="koordinator_lapangan_2_id_edit"
                                name="kordinator_lapangan2" required>
                                <option value="" selected disabled>Pilih Koordinator Lapangan 2</option>
                            </select>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.forEach(function(item) {
                        headSelect.append(
                            `<option value="${item.nik}">${item.full_name}</option>`);
                    });
                }
            });
